class FazCidades
  ...
  def initialize(array, size)
      @array = ["Abadia de Goiás", "Abadia dos Dourados", "Abadiânia", "Abaetetuba", "Abaeté", "Abaiara", "Abaré", "Abatiá", "Abaíra", "Abdon Batista", "Abel Figueiredo",
      ...
      "Álvares Florence", "Álvares Machado", "Álvaro de Carvalho", "Áurea", "Ângulo", "Érico Cardoso", "Óbidos", "Óleo"].sample(size)
      puts @array
      puts array
  end
end
